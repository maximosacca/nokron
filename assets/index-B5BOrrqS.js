...
`,zl={x:0,y:0};function Bl(e,t,n,r,i){let a=document.createElement(`div`);a.style.cssText=Rl+`grid-column: ${e}; grid-row: ${t};`,a.innerHTML=n;let o=e=>{e.preventDefault(),zl[r]=i},s=e=>{e.preventDefault(),zl[r]=0};a.addEventListener(`pointerdown`,o),a.addEventListener(`pointerup`,s),a.addEventListener(`pointerleave`,s),Ll.appendChild(a)}Bl(2,1,`▲`,`x`,-.05),Bl(2,3,`▼`,`x`,.05),Bl(1,2,`◀`,`y`,-.05),Bl(3,2,`▶`,`y`,.05);var Vl=document.createElement(`button`);Vl.textContent=`✕ Cerrar menú`,Vl.style.cssText=`

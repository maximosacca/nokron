...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function no(e,t,n){let r=new Float32Array(Ha),i=new K(0,1,0);return new wi({name:`SphericalGaussianBlur`,defines:{n:Ha,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ao(),fragmentShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=ws(i,i.VERTEX_SHADER,y),S=ws(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=As(i,x,`vertex`),n=As(i,S,`fragment`);H(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `}));hl.add(Sl);var Cl=new oo(128),wl=new ua(.1,100,Cl);hl.add(wl);var Tl=0,El=400,Dl={wireframe:new Ir({color:65416,wireframe:!0,transparent:!0,opacity:.85}),solido:new Ir({color:65416,transparent:!0,opacity:.55,side:2}),fresnel:new wi({uniforms:{glowColor:{value:new Y(3407786)}},transparent:!0,side:2,vertexShader:`
    ...
    `}),espejo:new Ei({color:1118481,metalness:1,roughness:.08,envMap:Cl.texture})},Ol=new Cn;Ol.position.y=.8,hl.add(Ol);var kl=[`huso`,`doble`,`conico`,`glitch`,`constante`],$={gesturesEnabled:!0,planeCount:40,totalHeight:1.8,twistTurns:.75,spiralRadius:0,jitter:0,profile:`huso`,material:`fresnel`,breathAmplitude:.05,breathSpeed:3,idleRotSpeed:.2,touchReacts:!0},Al={...$},jl=new ui(1,.015,1);function Ml(){for(;Ol.children.length;)Ol.remove(Ol.children[0]);let e=Dl[$.material]||Dl.fresnel;for(let t=0;t<$.planeCount;t++){let n=$.planeCount>1?t/($.planeCount-1):0,r=new Jr(jl,e);r.userData={t:n,jitterSeed:Math.random()-.5,glitchSeed:Math.random()},Ol.add(r)}}function Nl(){let e=Dl[$.material]||Dl.fresnel;Ol.children.forEach(t=>{t.material=e})}Ml();var Pl=new Cn;[{color:16746564,pos:[3.2,1.2,-1],geo:new ui(1.2,1.2,1.2)},{color:3407854,pos:[-3,-.5,1.5],geo:new hi(.9,.25,12,32)},{color:11167487,pos:[.5,2.6,-2.5],geo:new fi(.9,1.6,24)},{color:2293640,pos:[-1.5,-2.4,2],geo:new ui(2,.2,2)}].forEach(e=>{let t=new Jr(e.geo,new Ei({color:e.color,roughness:.4}));t.position.set(...e.pos),Pl.add(t)});var Fl=new ia(16746564,1.2,14);Fl.position.set(3,1,-1);var Il=new ia(3407854,1.2,14);Il.position.set(-3,-.5,1.5);var Ll=!1;function Rl(e){Ll=e,e?(hl.add(Pl),hl.add(Fl),hl.add(Il)):(hl.remove(Pl),hl.remove(Fl),hl.remove(Il))}var zl=document.createElement(`div`);zl.id=`dpad-cont`,zl.style.cssText=`
    position: fixed; bottom: 20px; left: 20px; z-index: 10;
    display: ${$.gesturesEnabled?`grid`:`none`};
    grid-template-columns: repeat(3, 45px); grid-template-rows: repeat(3, 45px); gap: 5px; opacity: 0.85;
`,document.body.appendChild(zl);var Bl=`
...
`,Vl={x:0,y:0};function Hl(e,t,n,r,i){let a=document.createElement(`div`);a.style.cssText=Bl+`grid-column: ${e}; grid-row: ${t};`,a.innerHTML=n;let o=e=>{e.preventDefault(),Vl[r]=i},s=e=>{e.preventDefault(),Vl[r]=0};a.addEventListener(`pointerdown`,o),a.addEventListener(`pointerup`,s),a.addEventListener(`pointerleave`,s),zl.appendChild(a)}Hl(2,1,`▲`,`y`,-.03),Hl(2,3,`▼`,`y`,.03),Hl(1,2,`◀`,`x`,-.03),Hl(3,2,`▶`,`x`,.03);var Ul=document.createElement(`button`);Ul.textContent=`✕ Cerrar menú`,Ul.style.cssText=`
...
`,document.body.appendChild(Ul);var Wl=document.createElement(`div`);Wl.style.cssText=`
...
`,document.body.appendChild(Wl);var Gl=!0;Ul.addEventListener(`click`,()=>{Gl=!Gl,Wl.style.display=Gl?`block`:`none`,Ul.textContent=Gl?`✕ Cerrar menú`:`☰ Abrir menú`});var Kl=document.createElement(`div`);Kl.textContent=`Fragmento de Memoria — laboratorio`,Kl.style.cssText=`font-size: 13px; color: #66ffaa; margin-bottom: 8px;`,Wl.appendChild(Kl);var ql=[`planeCount`],Jl=[`material`],Yl={};function Xl(e){if(ql.includes(e)&&Ml(),Jl.includes(e)&&Nl(),e===`gesturesEnabled`){let e=document.getElementById(`dpad-cont`);e&&(e.style.display=$.gesturesEnabled?`grid`:`none`)}}function Zl(e,t){return Number.isInteger(Al[e])&&typeof t==`number`?String(Math.round(t)):Number(t).toFixed(2)}function Ql(e){let t=Yl[e];t&&(t.type===`slider`?(t.input.value=$[e],t.span.textContent=`${t.label}: ${Zl(e,$[e])}`):t.type===`select`&&(t.select.value=$[e]))}var $l=0;function eu(e){let t=performance.now();t-$l>120&&(Ql(e),$l=t)}function tu(e){let t=document.createElement(`button`);return t.textContent=`↺`,t.style.cssText=`background:#001a0d; color:#66ffaa; border:1px solid #33ffaa; border-radius:4px; cursor:pointer; font-size:11px; padding:1px 6px; line-height:1.4;`,t.addEventListener(`click`,e),t}function nu(e,t,n,r,i){let a=document.createElement(`div`);a.style.cssText=`display:flex; flex-direction:column; gap:4px; margin-bottom:10px;`;let o=document.createElement(`div`);o.style.cssText=`display:flex; justify-content:space-between; align-items:center; gap:6px;`;let s=document.createElement(`span`);s.textContent=`${e}: ${Zl(t,$[t])}`,o.appendChild(s);let c=document.createElement(`input`);c.type=`range`,c.min=n,c.max=r,c.step=i,c.value=$[t],c.style.width=`100%`,c.addEventListener(`input`,()=>{$[t]=parseFloat(c.value),s.textContent=`${e}: ${Zl(t,$[t])}`,Xl(t)});let l=tu(()=>{$[t]=Al[t],c.value=Al[t],s.textContent=`${e}: ${Zl(t,$[t])}`,Xl(t)});o.appendChild(l),a.appendChild(o),a.appendChild(c),Wl.appendChild(a),Yl[t]={type:`slider`,input:c,span:s,label:e}}function ru(e,t,n){let r=document.createElement(`div`);r.style.cssText=`display:flex; flex-direction:column; gap:4px; margin-bottom:10px;`;let i=document.createElement(`div`);i.style.cssText=`display:flex; justify-content:space-between; align-items:center; gap:6px;`;let a=document.createElement(`span`);a.textContent=e,i.appendChild(a);let o=document.createElement(`select`);o.style.cssText=`background:#001a0d; color:#66ffaa; border:1px solid #33ffaa; border-radius:4px; padding:4px 6px; font-family:monospace; font-size:12px; width:100%;`,n.forEach(([e,n])=>{let r=document.createElement(`option`);r.value=e,r.textContent=n,e===$[t]&&(r.selected=!0),o.appendChild(r)}),o.addEventListener(`change`,()=>{$[t]=o.value,Xl(t)});let s=tu(()=>{$[t]=Al[t],o.value=Al[t],Xl(t)});i.appendChild(s),r.appendChild(i),r.appendChild(o),Wl.appendChild(r),Yl[t]={type:`select`,select:o}}function iu(e,t){let n=document.createElement(`div`);n.style.cssText=`display:flex; justify-content:space-between; align-items:center; gap:8px; margin-bottom:10px;`;let r=document.createElement(`label`);r.style.cssText=`display:flex; align-items:center; gap:8px;`;let i=document.createElement(`input`);i.type=`checkbox`,i.checked=$[t],i.addEventListener(`change`,()=>{$[t]=i.checked,Xl(t)}),r.appendChild(i);let a=document.createElement(`span`);a.textContent=e,r.appendChild(a),n.appendChild(r);let o=tu(()=>{$[t]=Al[t],i.checked=Al[t],Xl(t)});n.appendChild(o),Wl.appendChild(n)}iu(`Interacción reactiva (gestos modifican parámetros)`,`gesturesEnabled`);var au=document.createElement(`div`);au.style.cssText=`border-top:1px solid #144; margin: 4px 0 10px;`,Wl.appendChild(au),nu(`Cantidad de planos`,`planeCount`,6,120,1),nu(`Altura total (pellizco)`,`totalHeight`,.5,4,.05),nu(`Vueltas de twist`,`twistTurns`,0,6,.05),nu(`Radio de espiral (inclinación)`,`spiralRadius`,0,1.5,.02),nu(`Ruido / glitch (arrastre)`,`jitter`,0,1.5,.02),ru(`Perfil de silueta (tap)`,`profile`,[[`huso`,`Huso / capullo`],[`doble`,`Doble lóbulo`],[`conico`,`Cónico`],[`glitch`,`Aleatorio (glitch)`],[`constante`,`Constante (cilindro)`]]),ru(`Material`,`material`,[[`fresnel`,`Fresnel / borde brillante`],[`wireframe`,`Wireframe`],[`solido`,`Sólido translúcido`],[`espejo`,`Espejo reflectante`]]),nu(`Amplitud de respiración`,`breathAmplitude`,0,.3,.01),nu(`Velocidad de respiración`,`breathSpeed`,0,10,.1),nu(`Rotación pasiva`,`idleRotSpeed`,0,1.5,.02),iu(`Reacciona al mantener presionado`,`touchReacts`);var ou=document.createElement(`div`);ou.style.cssText=`border-top:1px solid #144; margin: 10px 0;`,Wl.appendChild(ou);var su=document.createElement(`button`);su.textContent=`Objetos y luces de prueba: OFF`,su.style.cssText=`width:100%; background:#001a0d; color:#66ffaa; border:1px solid #33ffaa; border-radius:4px; cursor:pointer; font-size:11px; padding:6px; margin-bottom:6px;`,su.addEventListener(`click`,()=>{Rl(!Ll),su.textContent=`Objetos y luces de prueba: ${Ll?`ON`:`OFF`}`}),Wl.appendChild(su);var cu=!1;window.addEventListener(`pointerdown`,()=>{cu=!0,ml&&(ml.textContent=`Se mueve`)}),window.addEventListener(`pointerup`,()=>{cu=!1,ml&&(ml.textContent=`No se mueve`)});var lu=_l.domElement;lu.style.touchAction=`none`;var uu=0,du=0,fu=0,pu=!1,mu=0,hu=null,gu=$.totalHeight,_u=0;function vu(e){let t=e[0].clientX-e[1].clientX,n=e[0].clientY-e[1].clientY;return Math.sqrt(t*t+n*n)}lu.addEventListener(`touchstart`,e=>{$.gesturesEnabled&&(mu=e.touches.length,vl.enabled=!1,e.touches.length===1?(uu=performance.now(),du=e.touches[0].clientX,fu=e.touches[0].clientY,pu=!1):e.touches.length===2&&(hu=vu(e.touches),gu=$.totalHeight))},{passive:!0}),lu.addEventListener(`touchmove`,e=>{if($.gesturesEnabled){if(mu=e.touches.length,e.touches.length===1){let t=e.touches[0].clientX-du,n=e.touches[0].clientY-fu,r=Math.sqrt(t*t+n*n);r>10&&(pu=!0,$.jitter=Tt.clamp($.jitter+r*6e-4,0,1.5),eu(`jitter`),du=e.touches[0].clientX,fu=e.touches[0].clientY)}else if(e.touches.length===2&&hu){let t=vu(e.touches)/hu;$.totalHeight=Tt.clamp(gu*t,.5,4),eu(`totalHeight`)}}},{passive:!0}),lu.addEventListener(`touchend`,e=>{if($.gesturesEnabled){if(mu=e.touches.length,e.touches.length===0){let e=performance.now()-uu;!pu&&e<300&&(_u=(_u+1)%kl.length,$.profile=kl[_u],Ql(`profile`)),hu=null,vl.enabled=!0}else e.touches.length===1&&(hu=null,uu=performance.now(),du=e.touches[0].clientX,fu=e.touches[0].clientY,pu=!1)}},{passive:!0});var yu=0;window.addEventListener(`deviceorientation`,e=>{if(!$.gesturesEnabled)return;let t=e.gamma||0;yu=Math.min(Math.abs(t)/45,1)*1.2}),window.addEventListener(`resize`,()=>{gl.aspect=window.innerWidth/window.innerHeight,gl.updateProjectionMatrix(),_l.setSize(window.innerWidth,window.innerHeight)});var bu=new wa;function xu(){requestAnimationFrame(xu);let e=bu.getDelta(),t=bu.getElapsedTime();$.gesturesEnabled&&($.spiralRadius=Tt.lerp($.spiralRadius,yu,.05),eu(`spiralRadius`),mu===0&&$.jitter>0&&($.jitter=Math.max(0,$.jitter-e*.05),eu(`jitter`)));let n=$.touchReacts&&cu,r=$.breathAmplitude*(n?2.6:1),i=$.breathSpeed*(n?1.8:1);Ol.children.forEach(e=>{let{t:n,jitterSeed:a,glitchSeed:o}=e.userData,s;switch($.profile){case`doble`:s=Math.abs(Math.sin(n*Math.PI*2))*1.4+.08;break;case`conico`:s=(1-n)*1.5+.08;break;case`glitch`:s=.3+o*1.3;break;case`constante`:s=1;break;default:s=Math.sin(n*Math.PI)*1.5+.08}let c=a*$.jitter,l=Math.sin(t*i+n*5)*r,u=Math.max(.03,s+c+l);e.scale.set(u,1,u);let d=n*Math.PI*2*$.twistTurns;e.position.set(Math.cos(d)*$.spiralRadius,(n-.5)*$.totalHeight,Math.sin(d)*$.spiralRadius),e.rotation.y=d+a*$.jitter*2});let a=$.idleRotSpeed*(n?2.2:1);if(Ol.rotation.y+=e*a,Vl.x!==0||Vl.y!==0){let e=new K().copy(gl.position).sub(vl.target),t=new Ta().setFromVector3(e);t.theta-=Vl.x,t.phi+=Vl.y,t.phi=Tt.clamp(t.phi,.1,Math.PI-.1),e.setFromSpherical(t),gl.position.copy(vl.target).add(e)}if($.material===`espejo`){let e=performance.now();e-Tl>El&&(Ol.visible=!1,wl.position.copy(Ol.position),wl.update(_l,hl),Ol.visible=!0,Tl=e)}vl.update(),_l.render(hl,gl)}xu();
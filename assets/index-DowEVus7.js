...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function co(e,t,n){let r=new Float32Array(Ja),i=new K(0,1,0);return new Ci({name:`SphericalGaussianBlur`,defines:{n:Ja,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:fo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lo(){return new Ci({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:fo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(){return new Ci({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fo(),fragmentShader:`
	...
	`}var po=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `}),espejo:new Ti({color:16777215,metalness:1,roughness:.05})},kl=new Cn;kl.position.y=.5,xl.add(kl);var Al=[`huso`,`doble`,`conico`,`glitch`,`constante`],$={gesturesEnabled:!0,planeCount:40,totalHeight:1.8,twistTurns:.75,spiralRadius:0,jitter:0,profile:`huso`,material:`fresnel`,breathAmplitude:.05,breathSpeed:3,idleRotSpeed:.2,touchReacts:!0},jl={...$},Ml=new ui(1,.002,1);function Nl(){for(;kl.children.length;)kl.remove(kl.children[0]);let e=Ol[$.material]||Ol.fresnel;for(let t=0;t<$.planeCount;t++){let n=$.planeCount>1?t/($.planeCount-1):0,r=new Jr(Ml,e);r.userData={t:n,jitterSeed:Math.random()-.5,glitchSeed:Math.random()},kl.add(r)}}function Pl(){let e=Ol[$.material]||Ol.fresnel;kl.children.forEach(t=>{t.material=e})}Nl();var Fl=new Cn;[{color:16746564,pos:[3.2,1.2,-1],geo:new ui(1.2,1.2,1.2)},{color:3407854,pos:[-3,-.5,1.5],geo:new mi(.9,.25,12,32)},{color:11167487,pos:[.5,2.6,-2.5],geo:new fi(.9,1.6,24)},{color:2293640,pos:[-1.5,-2.4,2],geo:new ui(2,.2,2)}].forEach(e=>{let t=new Jr(e.geo,new Ti({color:e.color,roughness:.4}));t.position.set(...e.pos),Fl.add(t)});var Il=new ua(16746564,1.2,14);Il.position.set(3,1,-1);var Ll=new ua(3407854,1.2,14);Ll.position.set(-3,-.5,1.5);var Rl=!1;function zl(e){Rl=e,e?(xl.add(Fl),xl.add(Il),xl.add(Ll)):(xl.remove(Fl),xl.remove(Il),xl.remove(Ll))}var Bl=document.createElement(`div`);Bl.id=`dpad-cont`,Bl.style.cssText=`
...
`,document.body.appendChild(Bl);var Vl=`
...
`,Hl={x:0,y:0};function Ul(e,t,n,r,i){let a=document.createElement(`div`);a.style.cssText=Vl+`grid-column: ${e}; grid-row: ${t};`,a.innerHTML=n;let o=e=>{e.preventDefault(),Hl[r]=i},s=e=>{e.preventDefault(),Hl[r]=0};a.addEventListener(`pointerdown`,o),a.addEventListener(`pointerup`,s),a.addEventListener(`pointerleave`,s),a.addEventListener(`contextmenu`,e=>e.preventDefault()),Bl.appendChild(a)}Ul(2,1,`▲`,`y`,-.03),Ul(2,3,`▼`,`y`,.03),Ul(1,2,`◀`,`x`,-.03),Ul(3,2,`▶`,`x`,.03);var Wl=document.createElement(`button`);Wl.textContent=`✕ Cerrar menú`,Wl.style.cssText=`
...
`,document.body.appendChild(Wl);var Gl=document.createElement(`div`);Gl.style.cssText=`
...
`,document.body.appendChild(Gl);var Kl=!0;Wl.addEventListener(`click`,()=>{Kl=!Kl,Gl.style.display=Kl?`block`:`none`,Wl.textContent=Kl?`✕ Cerrar menú`:`☰ Abrir menú`});var ql=document.createElement(`div`);ql.textContent=`Fragmento de Memoria — laboratorio`,ql.style.cssText=`font-size: 13px; color: #66ffaa; margin-bottom: 8px;`,Gl.appendChild(ql);var Jl=[`planeCount`],Yl=[`material`],Xl={};function Zl(e){if(Jl.includes(e)&&Nl(),Yl.includes(e)&&Pl(),e===`gesturesEnabled`){let e=document.getElementById(`dpad-cont`);e&&(e.style.display=$.gesturesEnabled?`grid`:`none`)}}function Ql(e,t){return Number.isInteger(jl[e])&&typeof t==`number`?String(Math.round(t)):Number(t).toFixed(2)}function $l(e){let t=Xl[e];t&&(t.type===`slider`?(t.input.value=$[e],t.span.textContent=`${t.label}: ${Ql(e,$[e])}`):t.type===`select`&&(t.select.value=$[e]))}var eu=0;function tu(e){let t=performance.now();t-eu>120&&($l(e),eu=t)}function nu(e){let t=document.createElement(`button`);return t.textContent=`↺`,t.style.cssText=`background:#001a0d; color:#66ffaa; border:1px solid #33ffaa; border-radius:4px; cursor:pointer; font-size:11px; padding:1px 6px; line-height:1.4;`,t.addEventListener(`click`,e),t}function ru(e,t,n,r,i){let a=document.createElement(`div`);a.style.cssText=`display:flex; flex-direction:column; gap:4px; margin-bottom:10px;`;let o=document.createElement(`div`);o.style.cssText=`display:flex; justify-content:space-between; align-items:center; gap:6px;`;let s=document.createElement(`span`);s.textContent=`${e}: ${Ql(t,$[t])}`,o.appendChild(s);let c=document.createElement(`input`);c.type=`range`,c.min=n,c.max=r,c.step=i,c.value=$[t],c.style.width=`100%`,c.addEventListener(`input`,()=>{$[t]=parseFloat(c.value),s.textContent=`${e}: ${Ql(t,$[t])}`,Zl(t)});let l=nu(()=>{$[t]=jl[t],c.value=jl[t],s.textContent=`${e}: ${Ql(t,$[t])}`,Zl(t)});o.appendChild(l),a.appendChild(o),a.appendChild(c),Gl.appendChild(a),Xl[t]={type:`slider`,input:c,span:s,label:e}}function iu(e,t,n){let r=document.createElement(`div`);r.style.cssText=`display:flex; flex-direction:column; gap:4px; margin-bottom:10px;`;let i=document.createElement(`div`);i.style.cssText=`display:flex; justify-content:space-between; align-items:center; gap:6px;`;let a=document.createElement(`span`);a.textContent=e,i.appendChild(a);let o=document.createElement(`select`);o.style.cssText=`background:#001a0d; color:#66ffaa; border:1px solid #33ffaa; border-radius:4px; padding:4px 6px; font-family:monospace; font-size:12px; width:100%;`,n.forEach(([e,n])=>{let r=document.createElement(`option`);r.value=e,r.textContent=n,e===$[t]&&(r.selected=!0),o.appendChild(r)}),o.addEventListener(`change`,()=>{$[t]=o.value,Zl(t)});let s=nu(()=>{$[t]=jl[t],o.value=jl[t],Zl(t)});i.appendChild(s),r.appendChild(i),r.appendChild(o),Gl.appendChild(r),Xl[t]={type:`select`,select:o}}function au(e,t){let n=document.createElement(`div`);n.style.cssText=`display:flex; justify-content:space-between; align-items:center; gap:8px; margin-bottom:10px;`;let r=document.createElement(`label`);r.style.cssText=`display:flex; align-items:center; gap:8px;`;let i=document.createElement(`input`);i.type=`checkbox`,i.checked=$[t],i.addEventListener(`change`,()=>{$[t]=i.checked,Zl(t)}),r.appendChild(i);let a=document.createElement(`span`);a.textContent=e,r.appendChild(a),n.appendChild(r);let o=nu(()=>{$[t]=jl[t],i.checked=jl[t],Zl(t)});n.appendChild(o),Gl.appendChild(n)}au(`Interacción reactiva (gestos modifican parámetros)`,`gesturesEnabled`);var ou=document.createElement(`div`);ou.style.cssText=`border-top:1px solid #144; margin: 4px 0 10px;`,Gl.appendChild(ou),ru(`Cantidad de planos`,`planeCount`,6,120,1),ru(`Altura total (pellizco)`,`totalHeight`,.5,4,.05),ru(`Vueltas de twist`,`twistTurns`,0,6,.05),ru(`Radio de espiral (inclinación)`,`spiralRadius`,0,1.5,.02),ru(`Ruido / glitch (arrastre)`,`jitter`,0,1.5,.02),iu(`Perfil de silueta (tap)`,`profile`,[[`huso`,`Huso / capullo`],[`doble`,`Doble lóbulo`],[`conico`,`Cónico`],[`glitch`,`Aleatorio (glitch)`],[`constante`,`Constante (cilindro)`]]),iu(`Material`,`material`,[[`fresnel`,`Fresnel / borde brillante`],[`wireframe`,`Wireframe`],[`solido`,`Sólido translúcido`],[`espejo`,`Espejo reflectante`]]),ru(`Amplitud de respiración`,`breathAmplitude`,0,.3,.01),ru(`Velocidad de respiración`,`breathSpeed`,0,10,.1),ru(`Rotación pasiva`,`idleRotSpeed`,0,1.5,.02),au(`Reacciona al mantener presionado`,`touchReacts`);var su=document.createElement(`div`);su.style.cssText=`border-top:1px solid #144; margin: 10px 0;`,Gl.appendChild(su);var cu=document.createElement(`button`);cu.textContent=`Objetos y luces de prueba: OFF`,cu.style.cssText=`width:100%; background:#001a0d; color:#66ffaa; border:1px solid #33ffaa; border-radius:4px; cursor:pointer; font-size:11px; padding:6px; margin-bottom:6px;`,cu.addEventListener(`click`,()=>{zl(!Rl),cu.textContent=`Objetos y luces de prueba: ${Rl?`ON`:`OFF`}`}),Gl.appendChild(cu);var lu=!1;window.addEventListener(`pointerdown`,()=>{lu=!0,bl&&(bl.textContent=`Se mueve`)}),window.addEventListener(`pointerup`,()=>{lu=!1,bl&&(bl.textContent=`No se mueve`)});var uu=Cl.domElement;uu.style.touchAction=`none`;var du=0,fu=0,pu=0,mu=!1,hu=0,gu=null,_u=$.totalHeight,vu=0;function yu(e){let t=e[0].clientX-e[1].clientX,n=e[0].clientY-e[1].clientY;return Math.sqrt(t*t+n*n)}uu.addEventListener(`touchstart`,e=>{$.gesturesEnabled&&(hu=e.touches.length,wl.enabled=!1,e.touches.length===1?(du=performance.now(),fu=e.touches[0].clientX,pu=e.touches[0].clientY,mu=!1):e.touches.length===2&&(gu=yu(e.touches),_u=$.totalHeight))},{passive:!0}),uu.addEventListener(`touchmove`,e=>{if($.gesturesEnabled){if(hu=e.touches.length,e.touches.length===1){let t=e.touches[0].clientX-fu,n=e.touches[0].clientY-pu,r=Math.sqrt(t*t+n*n);r>10&&(mu=!0,$.jitter=Tt.clamp($.jitter+r*6e-4,0,1.5),tu(`jitter`),fu=e.touches[0].clientX,pu=e.touches[0].clientY)}else if(e.touches.length===2&&gu){let t=yu(e.touches)/gu;$.totalHeight=Tt.clamp(_u*t,.5,4),tu(`totalHeight`)}}},{passive:!0}),uu.addEventListener(`touchend`,e=>{if($.gesturesEnabled){if(hu=e.touches.length,e.touches.length===0){let e=performance.now()-du;!mu&&e<300&&(vu=(vu+1)%Al.length,$.profile=Al[vu],$l(`profile`)),gu=null,wl.enabled=!0}else e.touches.length===1&&(gu=null,du=performance.now(),fu=e.touches[0].clientX,pu=e.touches[0].clientY,mu=!1)}},{passive:!0});var bu=0;window.addEventListener(`deviceorientation`,e=>{if(!$.gesturesEnabled)return;let t=e.gamma||0;bu=Math.min(Math.abs(t)/45,1)*1.2}),window.addEventListener(`resize`,()=>{Sl.aspect=window.innerWidth/window.innerHeight,Sl.updateProjectionMatrix(),Cl.setSize(window.innerWidth,window.innerHeight)});var xu=new Aa;function Su(){requestAnimationFrame(Su);let e=xu.getDelta(),t=xu.getElapsedTime();$.gesturesEnabled&&($.spiralRadius=Tt.lerp($.spiralRadius,bu,.05),tu(`spiralRadius`),hu===0&&$.jitter>0&&($.jitter=Math.max(0,$.jitter-e*.05),tu(`jitter`)));let n=$.touchReacts&&lu,r=$.breathAmplitude*(n?2.6:1),i=$.breathSpeed*(n?1.8:1);kl.children.forEach(e=>{let{t:n,jitterSeed:a,glitchSeed:o}=e.userData,s;switch($.profile){case`doble`:s=Math.abs(Math.sin(n*Math.PI*2))*1.4+.08;break;case`conico`:s=(1-n)*1.5+.08;break;case`glitch`:s=.3+o*1.3;break;case`constante`:s=1;break;default:s=Math.sin(n*Math.PI)*1.5+.08}let c=a*$.jitter,l=Math.sin(t*i+n*5)*r,u=Math.max(.03,s+c+l);e.scale.set(u,1,u);let d=n*Math.PI*2*$.twistTurns;e.position.set(Math.cos(d)*$.spiralRadius,(n-.5)*$.totalHeight,Math.sin(d)*$.spiralRadius),e.rotation.y=d+a*$.jitter*2});let a=$.idleRotSpeed*(n?2.2:1);if(kl.rotation.y+=e*a,Hl.x!==0||Hl.y!==0){let e=new K().copy(Sl.position).sub(wl.target),t=new ja().setFromVector3(e);t.theta-=Hl.x,t.phi+=Hl.y,t.phi=Tt.clamp(t.phi,.1,Math.PI-.1),e.setFromSpherical(t),Sl.position.copy(wl.target).add(e)}wl.update(),Cl.render(xl,Sl)}Su();
...
void main() {
    ...
    `}),espejo:new Ti({color:16777215,metalness:1,roughness:.05})},Ml=new Cn;Ml.position.y=.5,bl.add(Ml);var Nl=[`huso`,`doble`,`conico`,`glitch`,`constante`],$={gesturesEnabled:!0,planeCount:40,totalHeight:1.8,twistTurns:.75,spiralRadius:0,jitter:0,profile:`huso`,material:`fresnel`,breathAmplitude:.05,breathSpeed:3,idleRotSpeed:.2,touchReacts:!0},Pl={...$},Fl=new ui(1,.002,1);function Il(){for(;Ml.children.length;)Ml.remove(Ml.children[0]);let e=jl[$.material]||jl.fresnel;for(let t=0;t<$.planeCount;t++){let n=$.planeCount>1?t/($.planeCount-1):0,r=new Jr(Fl,e);r.userData={t:n,jitterSeed:Math.random()-.5,glitchSeed:Math.random()},Ml.add(r)}}function Ll(){let e=jl[$.material]||jl.fresnel;Ml.children.forEach(t=>{t.material=e})}Il();var Rl=new Cn;[{color:16746564,pos:[3.2,1.2,-1],geo:new ui(1.2,1.2,1.2)},{color:3407854,pos:[-3,-.5,1.5],geo:new mi(.9,.25,12,32)},{color:11167487,pos:[.5,2.6,-2.5],geo:new fi(.9,1.6,24)},{color:2293640,pos:[-1.5,-2.4,2],geo:new ui(2,.2,2)}].forEach(e=>{let t=new Jr(e.geo,new Ti({color:e.color,roughness:.4}));t.position.set(...e.pos),Rl.add(t)});var zl=new ua(16746564,1.2,14);zl.position.set(3,1,-1);var Bl=new ua(3407854,1.2,14);Bl.position.set(-3,-.5,1.5);var Vl=!1;function Hl(e){Vl=e,e?(bl.add(Rl),bl.add(zl),bl.add(Bl)):(bl.remove(Rl),bl.remove(zl),bl.remove(Bl))}var Ul=document.createElement(`div`);Ul.id=`dpad-cont`,Ul.style.cssText=`
...
`,document.body.appendChild(Ul);var Wl=`
...
`,Gl={x:0,y:0};function Kl(e,t,n,r,i){let a=document.createElement(`div`);a.style.cssText=Wl+`grid-column: ${e}; grid-row: ${t};`,a.innerHTML=n;let o=e=>{e.preventDefault(),Gl[r]=i},s=e=>{e.preventDefault(),Gl[r]=0};a.addEventListener(`pointerdown`,o),a.addEventListener(`pointerup`,s),a.addEventListener(`pointerleave`,s),a.addEventListener(`contextmenu`,e=>e.preventDefault()),Ul.appendChild(a)}Kl(2,1,`▲`,`y`,-.03),Kl(2,3,`▼`,`y`,.03),Kl(1,2,`◀`,`x`,-.03),Kl(3,2,`▶`,`x`,.03);var ql=document.createElement(`button`);ql.textContent=`✕ Cerrar menú`,ql.style.cssText=`
...
`,document.body.appendChild(ql);var Jl=document.createElement(`div`);Jl.style.cssText=`
...
`,document.body.appendChild(Jl);var Yl=!0;ql.addEventListener(`click`,()=>{Yl=!Yl,Jl.style.display=Yl?`block`:`none`,ql.textContent=Yl?`✕ Cerrar menú`:`☰ Abrir menú`});var Xl=document.createElement(`div`);Xl.textContent=`Fragmento de Memoria — laboratorio`,Xl.style.cssText=`font-size: 13px; color: #66ffaa; margin-bottom: 8px;`,Jl.appendChild(Xl);var Zl=[`planeCount`],Ql=[`material`],$l={};function eu(e){if(Zl.includes(e)&&Il(),Ql.includes(e)&&Ll(),e===`gesturesEnabled`){let e=document.getElementById(`dpad-cont`);e&&(e.style.display=$.gesturesEnabled?`grid`:`none`)}}function tu(e,t){return Number.isInteger(Pl[e])&&typeof t==`number`?String(Math.round(t)):Number(t).toFixed(2)}function nu(e){let t=document.createElement(`button`);return t.textContent=`↺`,t.style.cssText=`background:#001a0d; color:#66ffaa; border:1px solid #33ffaa; border-radius:4px; cursor:pointer; font-size:11px; padding:1px 6px; line-height:1.4;`,t.addEventListener(`click`,e),t}function ru(e,t,n,r,i){let a=document.createElement(`div`);a.style.cssText=`display:flex; flex-direction:column; gap:4px; margin-bottom:10px;`;let o=document.createElement(`div`);o.style.cssText=`display:flex; justify-content:space-between; align-items:center; gap:6px;`;let s=document.createElement(`span`);s.textContent=`${e}: ${tu(t,$[t])}`,o.appendChild(s);let c=document.createElement(`input`);c.type=`range`,c.min=n,c.max=r,c.step=i,c.value=$[t],c.style.width=`100%`,c.addEventListener(`input`,()=>{$[t]=parseFloat(c.value),s.textContent=`${e}: ${tu(t,$[t])}`,eu(t)});let l=nu(()=>{$[t]=Pl[t],c.value=Pl[t],s.textContent=`${e}: ${tu(t,$[t])}`,eu(t)});o.appendChild(l),a.appendChild(o),a.appendChild(c),Jl.appendChild(a),$l[t]={type:`slider`,input:c,span:s,label:e}}function iu(e,t,n){let r=document.createElement(`div`);r.style.cssText=`display:flex; flex-direction:column; gap:4px; margin-bottom:10px;`;let i=document.createElement(`div`);i.style.cssText=`display:flex; justify-content:space-between; align-items:center; gap:6px;`;let a=document.createElement(`span`);a.textContent=e,i.appendChild(a);let o=document.createElement(`select`);o.style.cssText=`background:#001a0d; color:#66ffaa; border:1px solid #33ffaa; border-radius:4px; padding:4px 6px; font-family:monospace; font-size:12px; width:100%;`,n.forEach(([e,n])=>{let r=document.createElement(`option`);r.value=e,r.textContent=n,e===$[t]&&(r.selected=!0),o.appendChild(r)}),o.addEventListener(`change`,()=>{$[t]=o.value,eu(t)});let s=nu(()=>{$[t]=Pl[t],o.value=Pl[t],eu(t)});i.appendChild(s),r.appendChild(i),r.appendChild(o),Jl.appendChild(r),$l[t]={type:`select`,select:o}}function au(e,t){let n=document.createElement(`div`);n.style.cssText=`display:flex; justify-content:space-between; align-items:center; gap:8px; margin-bottom:10px;`;let r=document.createElement(`label`);r.style.cssText=`display:flex; align-items:center; gap:8px;`;let i=document.createElement(`input`);i.type=`checkbox`,i.checked=$[t],i.addEventListener(`change`,()=>{$[t]=i.checked,eu(t)}),r.appendChild(i);let a=document.createElement(`span`);a.textContent=e,r.appendChild(a),n.appendChild(r);let o=nu(()=>{$[t]=Pl[t],i.checked=Pl[t],eu(t)});n.appendChild(o),Jl.appendChild(n)}au(`Interacción reactiva (gestos modifican parámetros)`,`gesturesEnabled`);var ou=document.createElement(`div`);ou.style.cssText=`border-top:1px solid #144; margin: 4px 0 10px;`,Jl.appendChild(ou),ru(`Cantidad de planos`,`planeCount`,6,120,1),ru(`Altura total (pellizco)`,`totalHeight`,.5,4,.05),ru(`Vueltas de twist`,`twistTurns`,0,6,.05),ru(`Radio de espiral (inclinación)`,`spiralRadius`,0,1.5,.02),ru(`Ruido / glitch (arrastre)`,`jitter`,0,1.5,.02),iu(`Perfil de silueta (tap)`,`profile`,[[`huso`,`Huso / capullo`],[`doble`,`Doble lóbulo`],[`conico`,`Cónico`],[`glitch`,`Aleatorio (glitch)`],[`constante`,`Constante (cilindro)`]]),iu(`Material`,`material`,[[`fresnel`,`Fresnel / borde brillante`],[`wireframe`,`Wireframe`],[`solido`,`Sólido translúcido`],[`espejo`,`Espejo reflectante`]]),ru(`Amplitud de respiración`,`breathAmplitude`,0,.3,.01),ru(`Velocidad de respiración`,`breathSpeed`,0,10,.1),ru(`Rotación pasiva`,`idleRotSpeed`,0,1.5,.02),au(`Reacciona al mantener presionado`,`touchReacts`);var su=document.createElement(`div`);su.style.cssText=`border-top:1px solid #144; margin: 10px 0;`,Jl.appendChild(su);var cu=document.createElement(`button`);cu.textContent=`Objetos y luces de prueba: OFF`,cu.style.cssText=`width:100%; background:#001a0d; color:#66ffaa; border:1px solid #33ffaa; border-radius:4px; cursor:pointer; font-size:11px; padding:6px; margin-bottom:6px;`,cu.addEventListener(`click`,()=>{Hl(!Vl),cu.textContent=`Objetos y luces de prueba: ${Vl?`ON`:`OFF`}`}),Jl.appendChild(cu);var lu=!1;window.addEventListener(`pointerdown`,()=>{lu=!0}),window.addEventListener(`pointerup`,()=>{lu=!1});var uu=Sl.domElement;uu.style.touchAction=`none`;var du=0,fu=0,pu=0,mu=!1,hu=0,gu=null,_u=$.totalHeight,vu=0,yu=0,bu=1,xu=0;function Su(e){let t=e[0].clientX-e[1].clientX,n=e[0].clientY-e[1].clientY;return Math.sqrt(t*t+n*n)}uu.addEventListener(`touchstart`,e=>{$.gesturesEnabled&&(hu=e.touches.length,Cl.enabled=!1,e.touches.length===1?(du=performance.now(),fu=e.touches[0].clientX,pu=e.touches[0].clientY,mu=!1):e.touches.length===2&&(gu=Su(e.touches),_u=$.totalHeight))},{passive:!0}),uu.addEventListener(`touchmove`,e=>{if($.gesturesEnabled){if(hu=e.touches.length,e.touches.length===1){let t=e.touches[0].clientX-fu,n=e.touches[0].clientY-pu,r=Math.sqrt(t*t+n*n);r>10&&(mu=!0,$.jitter=Tt.clamp($.jitter+r*.0015,0,2),fu=e.touches[0].clientX,pu=e.touches[0].clientY)}else if(e.touches.length===2&&gu){let t=Su(e.touches)/gu;$.totalHeight=Tt.clamp(_u*t,.5,4)}}},{passive:!0}),uu.addEventListener(`touchend`,e=>{if($.gesturesEnabled){if(hu=e.touches.length,e.touches.length===0){let e=performance.now()-du;if(!mu&&e<300){let e=performance.now();e-xu<400?(kl=(kl+1)%Ol.length,Al(kl),xu=0):(bu>=1&&(yu=(vu+1)%Nl.length,bu=0),xu=e)}gu=null,Cl.enabled=!0}else e.touches.length===1&&(gu=null,du=performance.now(),fu=e.touches[0].clientX,pu=e.touches[0].clientY,mu=!1)}},{passive:!0});var Cu=0;window.addEventListener(`deviceorientation`,e=>{if(!$.gesturesEnabled)return;let t=e.gamma||0;Cu=Math.min(Math.abs(t)/45,1)*1.2}),window.addEventListener(`resize`,()=>{xl.aspect=window.innerWidth/window.innerHeight,xl.updateProjectionMatrix(),Sl.setSize(window.innerWidth,window.innerHeight)});var wu=new Aa;function Tu(e,t,n){switch(e){case`doble`:return Math.abs(Math.sin(t*Math.PI*2))*1.4+.08;case`conico`:return(1-t)*1.5+.08;case`glitch`:return .3+n*1.3;case`constante`:return 1;default:return Math.sin(t*Math.PI)*1.5+.08}}function Eu(){requestAnimationFrame(Eu);let e=wu.getDelta(),t=wu.getElapsedTime();$.gesturesEnabled&&($.spiralRadius=Tt.lerp($.spiralRadius,Cu,.05),hu===0&&$.jitter>0&&($.jitter=Math.max(0,$.jitter-e*.5))),bu<1&&(bu+=e*1.2,bu>1&&(bu=1,vu=yu));let n=$.touchReacts&&lu,r=$.breathAmplitude*(n?2.6:1),i=$.breathSpeed*(n?1.8:1);Ml.children.forEach(e=>{let{t:n,jitterSeed:a,glitchSeed:o}=e.userData,s=Tu(Nl[vu],n,o),c=Tu(Nl[yu],n,o),l=Tt.smoothstep(bu,0,1),u=Tt.lerp(s,c,l),d=Math.sin(n*15+t*4)*Math.cos(n*8-t*2)*$.jitter,f=Math.sin(t*i+n*5)*r,p=Math.max(.01,u+d+f);e.scale.set(p,1,p);let m=n*Math.PI*2*$.twistTurns;e.position.set(Math.cos(m)*$.spiralRadius,(n-.5)*$.totalHeight,Math.sin(m)*$.spiralRadius),e.rotation.y=m+d});let a=$.idleRotSpeed*(n?2.2:1);if(Ml.rotation.y+=e*a,Gl.x!==0||Gl.y!==0){let e=new K().copy(xl.position).sub(Cl.target),t=new ja().setFromVector3(e);t.theta-=Gl.x,t.phi+=Gl.y,t.phi=Tt.clamp(t.phi,.1,Math.PI-.1),e.setFromSpherical(t),xl.position.copy(Cl.target).add(e)}Cl.update(),Sl.render(bl,xl)}Eu();